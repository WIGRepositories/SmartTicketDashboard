...
var ctrl = app.controller('myCtrl', function ($scope, $http, $localStorage, $uibModal, fileReader, $upload, $filter) {
    ...
    $scope.Getbrandusers = function () {
        $http.get('/api/BrandAmbassador/Getbrandusers?Id='+$scope.ct.Id).then(function (response, req) {
            $scope.brandusers = response.data;
        });
    }
    ...
    $scope.saveNew = function (brand, flag) {

        if (brand == null) {
            alert('Please Enter Details');
            return;
        }
        if (brand.firstname == null) {
            alert('Please Enter First Name');
            return;
        }

        if (brand.lastname == null) {
            alert('Please Enter Last Name');
            return;
        }
        //if (brand.middlename == null) {
        //    alert('Please Enter Middle Name');
        //    return;
        //}
        if (brand.ContactNo1 == null) {
            alert('Please Enter Contact No1');
            return;
        }
        if (brand.ContactNo2 == null) {
            alert('Please Enter Contact No2');
            return;
        }
        if (brand.Email == null) {
        ...
        if ($scope.gender == null || $scope.gender.Id == null) {
        ...
        var brand = {
            ...
            middlename: brand.middlename,
            Address: brand.Address,
            contact1: brand.ContactNo1,
            contact2: brand.ContactNo2,
            email: brand.Email,
            category: brand.category,
            gender: $scope.gender.Id,                  
            DOJ: brand.DOJ,
            Effectivedate: brand.Effectivedate,
            Active: brand.active,
    ...
    $scope.GetConfigData = function () {
        ...
        $http(req).then(function (res) {
            $scope.initdata = res.data;
            $scope.ct = $scope.initdata.Table1[0];
            $scope.Getbrandusers();
        });
    }
