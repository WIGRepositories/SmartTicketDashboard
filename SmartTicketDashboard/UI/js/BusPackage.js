...
var ctrl = app.controller('myCtrl', function ($scope, $http, $localStorage, $uibModal, $upload) {
    ...
    $scope.GetChargesDiscounts = function () {
        ...
        $http.get('/api/BusPackage/GetBusPackage').then(function (res, data) {
    ...
    $scope.GetfleetOwner = function () {
        ...
        $http.get('/api/FleetOwner/getFleetOwner').then(function (res, data) {
    ...
    $scope.AddChargesDiscounts = function (Addcharges, flag) {
        ...
        var Addcharges = {
            ...
            RouteId: Addcharges.RouteId.Id,
            FleetOwnerId: Addcharges.FleetOwnerId.Id,
            Active: (Addcharges.Active == true) ? 1 : 0,
        }

        var req = {
            method: 'POST',
            url: '/api/BusPackage/SaveBuspackages',
            data: Addcharges
        }
    ...
    $scope.EditChargesDiscounts = function (Editcharges) {
        ...
        var Editcharges = {
            ...
            RouteId: Editcharges.RouteId.Id,
            FleetOwnerId: Editcharges.FleetOwnerId.Id,
