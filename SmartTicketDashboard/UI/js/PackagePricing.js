...
var mycrtl1 = myapp1.controller('myCtrl', function ($scope, $http, $localStorage, $uibModal, $upload, $timeout, fileReader, $filter) {
    ...
    //-------get--------
    $scope.GetPackagesPricing = function () {
        ...
        $http.get('/api/PackagesPricing/GetPackagesPricing').then(function (res, data) {
            $scope.PackagePricing = res.data;
        });
    }
    //------get---------
    ...
    //-------post(I)--------
    $scope.savenew = function (Pricing) {
        ...
        var req = {
            method: 'POST',
            url: '/api/Packages/PackagesPricingPost',
            //headers: {
